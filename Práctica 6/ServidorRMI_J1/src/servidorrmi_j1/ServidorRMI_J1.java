...
import interfazp6.ConexionServer1;
import interfazp6.ConexionServer2;
import interfazp6.interfaceS1;
 ...
 * @author jSeba
 */
public class ServidorRMI_J1 extends UnicastRemoteObject implements interfaceS1,ConexionServer1{
    ...
    public ServidorRMI_J1() throws RemoteException
    {
    ...
    public void iniciarServidor()
    {
        try {
            ...
            registry.bind("operacionservidor1",(interfaceS1)this);//se guarda con la clave "operacionservidor" en el registro la instancia de la clase OperacionServidor pero con un cast a la interface
            registry.bind("server1", (ConexionServer1)this);
        } catch (Exception e) {
