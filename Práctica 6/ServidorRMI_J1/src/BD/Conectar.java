...
public class Conectar {
    ...
    private static final String url = "jdbc:mysql://localhost:3306/juegocartass1";//contiene el host al que se va a conectar y el número de puerto, además del nombre de la bd
