...
public class JugadorForm extends javax.swing.JFrame implements Runnable{
    ...
    public JugadorForm() throws UnknownHostException {
        ...
        try{
            ...
            servidorObj = (interfaceS1)(registry.lookup("operacionservidor1"));//localiza lo guardado en el registro con la palabra "operacionservidor"
        }catch(Exception e){System.out.println("No se pudo obtener el registro de server 1: "+e);}
