...
public class Modifica extends javax.swing.JFrame {
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        ...
        switch (invocador)
        {
            ...
            break;
            case 2:
                nuevo.r2.hora=hora.toString();
                nuevo.r2.minutos=minutos.toString();
                relojOriginal.h2.resume();
            break;
            case 3:
                nuevo.r3.hora=hora.toString();
                nuevo.r3.minutos=minutos.toString();
                relojOriginal.h3.resume();
            break;
            case 4:
                nuevo.r4.hora=hora.toString();
                nuevo.r4.minutos=minutos.toString();
                relojOriginal.h4.resume();
            break;
