 ...
 * @author jSeba
 */
//public class ServidorRMI_2 extends UnicastRemoteObject implements InterfaceJugadores,ConexionServer2{
  public class ServidorRMI_2 extends UnicastRemoteObject implements InterfaceJugadores,InterfaceServidores{  
    ...
    public void iniciarServidor()
    {
        try {
            ...
            registry.bind("opServidor2",(InterfaceJugadores)this);//se guarda con la clave "operacionservidor" en el registro la instancia de la clase OperacionServidor pero con un cast a la interface
            registry.bind("server2", (InterfaceServidores)this);//hace un registro para la conexion entre servidores
        } catch (Exception e) {
    ...
    public String darCarta(String ipJugador, String hora) throws RemoteException {
        System.out.println("darCarta S2");
