 ...
 * @author jSeba
 */
public class ServidorCartas extends UnicastRemoteObject implements InterfaceServidor{
    ...
    public ServidorCartas() throws RemoteException
    {
    ...
    public void iniciarServidor()
    {
        try
        {
            ...
            registry.bind("operacionservidor",(InterfaceServidor)this);//se guarda con la clave "operacionservidor" en el registro la instancia de la clase OperacionServidor pero con un cast a la interface
         // System.out.println(toMilis("10:30:25"));
        }catch(Exception e)
        {
           e.printStackTrace();
        }
