...
public class Cls_Servidor {
    ...
    private final String SQL_INSERT_peticion = "INSERT INTO peticion (ID_CARTA,ip_jugador,valor_carta) values(?,?,?)";//cuando empieza la partida
    ...
    public int insertPartida(String fecha,String hora_inicio) throws SQLException
    {
        int res = 0;
        try
        {
    ...
    public int updatePartida(String hora_fin,String hora_inicio, String fecha) throws SQLException //update para agregar la fecha final
    {
    ...
    public int insertPeticion(String idCarta,String ipJugador,String valorCarta) throws SQLException
    {
       
        int res = 0;
        try
        {
            System.out.println("idCarta: "+idCarta+" ipJugador: "+ipJugador+" valorCarta: "+valorCarta);
