...
public class RelojC1 extends javax.swing.JFrame implements Runnable {
    ...
    public void run() {
        ...
        while (ct == horaHiloC1) //mientras el hilo se este ejecutando
        {
            ...
            System.out.println("segunderoHora: "+horaC1.segundos);
            try {
                Thread.sleep(timer1);
...
public class SockerEscucha extends Thread {
    ...
    public SockerEscucha(){
        try {  
            ...
            System.out.println("Serversocket creado en puerto 6677 para hora");
        } catch (IOException ex) {
            System.out.println("Error creando Serversocket en puerto 6677 para hora");
        }
    }
    @Override
    public void run() {
                ...
                while(true){
                    ...
                    if(parts[0]!=null)
                    {
                        valorRecibido++;
                        horaC1.hora=parts[0];
                        horaC1.minutos=parts[1];
                        horaC1.segundos=parts[2];
                    }
