 ...
 * @author jSeba
 */
public class P5ServidorJ2 extends UnicastRemoteObject implements ConexionServer2,InterfazParaJugadores,InterfazServidoresSincronización{

    private static final long serialVersionUID = 9061868373895430621L; //serializacion 
    private static final int PUERTO = 3234;
    ...
    public P5ServidorJ2()throws RemoteException
    {
        ...
        {
            System.out.println("Error al obtener referencia del servidor UTC en server 2: "+e);
        }
    }
    ...
    public void iniciarServidor()
    {
        try {
            ...
            registry.bind("registroJ2",(InterfazParaJugadores)this);//se guarda con la clave "operacionservidor" en el registro la instancia de la clase OperacionServidor pero con un cast a la interface
        } catch (Exception e) {
            System.out.println("No se pudo hacer el inicio del Servidor 2");
        }
    }
    ...
    //FUNCIONES REMOTAS DEL SERVER 1 AL SERVER 2
    @Override
    public void queryRemoto(String consulta) throws RemoteException {
        ...
        try {
            ...
            System.out.println("No se pudo recibir consulta remota en server 2: "+ex);
        }
    }
    ...
    //FUNCIONES REMOTAS PARA JUGADOR 2
    @Override
