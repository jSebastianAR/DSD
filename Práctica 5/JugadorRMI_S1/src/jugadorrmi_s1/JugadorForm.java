...
public class JugadorForm extends javax.swing.JFrame implements Runnable{
    ...
    int timer1 = 1000;
    Registry registry;
    InterfazParaJugadores servidorObj;
    ...
    public JugadorForm() throws UnknownHostException {
        ...
        try{
            ...
            servidorObj = (InterfazParaJugadores)(registry.lookup("registroJ1"));//localiza lo guardado en el registro con la palabra "operacionservidor"
