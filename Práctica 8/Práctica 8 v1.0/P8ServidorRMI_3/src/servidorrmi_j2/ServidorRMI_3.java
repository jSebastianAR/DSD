 ...
 */
  ...
  public class ServidorRMI_3 extends UnicastRemoteObject implements InterfaceJugadores,InterfaceServidores{  
    ...
    public String serverPass = "opServidor3";
    ...
    public final int ID=3; //Servidor con prioridad 3, es decir es el de menor prioridad
    ...
    @Override
    public void agregaFE_cliente(InterfaceFE FE) throws RemoteException {
        if(numJugador==0)
        {
    ...
    @Override
    public void agregaFE_Server(InterfaceFE[] FE) throws RemoteException {
      this.FE = FE;
