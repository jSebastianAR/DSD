 ...
 * @author jSeba
 */
public class FrontEndJ1 extends UnicastRemoteObject implements InterfaceFE{
    ...
    Registry registry;
    public String serverAddress="localhost" , serverPass="opServidor1";
    public int serverPort=3000;
    
    public FrontEndJ1(String ip1,String ip2,String ip3) throws RemoteException
    {
...
////                return b;
    ...
    public void cambioCoordinador(String ipCoordinador, int puerto, String pass) throws RemoteException {
        serverAddress = ipCoordinador;
        serverPort = puerto;
        serverPass = pass;
        
        System.out.println("El nuevo coordinador es:"+serverAddress+ "puerto: "+serverPort);
    }
