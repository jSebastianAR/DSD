...
public class JugadorForm extends javax.swing.JFrame implements Runnable{
    ...
    public JugadorForm() throws UnknownHostException, RemoteException {
        initComponents();
        ...
        FE = new FrontEndJ1("localhost","localhost","localhost");
    ...
    private void pedirCartaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pedirCartaActionPerformed
        try {
            String carta = FE.pedirCarta2(ip, lblReloj.getText());//Hace la peticion al front end
